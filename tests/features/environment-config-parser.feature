...
Feature: Environment Configuration Parser
    ...
    Scenario Outline: EnvironmentConfigParser Methods
        ...
        Examples:
            ...
            | ROUTER_RULE_COUNTRY_GB             | { "destination_namespaces": "GB", "destination_topics": "gb.topic", "jmespath": "country", "regexp": "^GB$", "source_subscription": "test", "source_topic": "topic.1", "max_tasks": 1} | get_rules             |
