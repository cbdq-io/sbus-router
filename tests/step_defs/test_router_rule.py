...
@then(parsers.parse('session_count is {session_count:d}'))
def _(session_count: int, router_rule: RouterRule):
    """session_count is <session_count>."""
    assert session_count == router_rule.session_count
